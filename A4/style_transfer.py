...
def content_loss(content_weight, content_current, content_original):
    ...
    scalar_content_loss = content_weight * torch.sum((content_current.reshape(1, C, H*W) - content_original.reshape(1, C, H*W)) ** 2)
...
def style_loss(feats, style_layers, style_targets, style_weights):
    ...
    for i in range(len(style_layers)):
        ...
        style_loss += style_weight * torch.sum((gram_current - style_target)**2)
    return style_loss
    ##############################################################################
    #                               END OF YOUR CODE                             #
    ##############################################################################
