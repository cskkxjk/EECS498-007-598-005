...
def discriminator_loss(logits_real, logits_fake):
  ...
  loss = 2 * torch.nn.functional.binary_cross_entropy_with_logits(torch.cat((logits_real, logits_fake)), label)
  ##############################################################################
  #                              END OF YOUR CODE                              #
  ##############################################################################
  return loss
...
def generator_loss(logits_fake):
  ...
  loss = torch.nn.functional.binary_cross_entropy_with_logits(logits_fake, label_fake)
  ##############################################################################
  #                              END OF YOUR CODE                              #
  ##############################################################################
  return loss
...
def build_dc_classifier():
  ...
  # Replace "pass" statement with your code
  model = nn.Sequential(
    nn.Unflatten(1, (1, 28, 28)), # N, 1, 28, 28
