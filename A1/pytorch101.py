...
def count_negative_entries(x):
  ...
  """
    ...
    # Replace "pass" statement with your code
    count_mask = x < 0
    num_neg = int(torch.sum(count_mask))
    #############################################################################
    #                            END OF YOUR CODE                               #
    #############################################################################
    return num_neg
...
def make_one_hot(x):
  ...
  """
    ...
    y = y.scatter(1, torch.tensor(x).reshape(-1, 1), 1)
    #############################################################################
    #                            END OF YOUR CODE                               #
    #############################################################################
    return y
...
def reshape_practice(x):
  ...
  """
    ...
    #############################################################################
    # Replace "pass" statement with your code
    # y = torch.cat((x.view(6, 4)[:3], x.view(6, 4)[3:]), dim=1)
    y = x.view(2, 1, -1).reshape(2, 3, 4).permute(1, 0, 2).reshape(3, -1)
